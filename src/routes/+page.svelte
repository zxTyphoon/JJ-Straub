<script>
	...
	const ogImage = 'https://www.jjstraub.com/JJStraub_Headshot-og.webp';
	...
	// Built here rather than inline: a literal script tag in markup breaks the Svelte eslint parser.
	// The \/ escape is required — an unescaped closing tag would end this block early.
...
<svelte:head>
	...
	<link rel="preconnect" href="https://iet4nqumkcygt4t7.public.blob.vercel-storage.com" />
	...
	<!-- Static, author-controlled structured data — no user input reaches this string. -->

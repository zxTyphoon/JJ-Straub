...
<div class="min-h-screen bg-surface-900 pt-24 pb-16">
	<div class="max-w-4xl mx-auto px-6 md:px-12">
		<!-- Header -->
		<div class="mb-12">
			<a
				href="/"
				class="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 transition-colors duration-300 mb-6 group"
			>
				<svg
			...
			<h1 class="text-4xl md:text-5xl font-bold text-white mb-4">{$_('legalNotice')}</h1>
			<div class="h-1 w-24 bg-gradient-to-r from-primary-500 to-primary-400 rounded-full"></div>
		</div>

		<!-- Content -->
		<div class="space-y-10">
			<section class="bg-surface-800/50 rounded-2xl p-6 md:p-8 border border-white/5">
				<h2 class="text-xl font-semibold text-white mb-4 flex items-center gap-3">
					<span class="w-8 h-8 rounded-lg bg-primary-500/20 flex items-center justify-center">
						<svg
				...
				<div class="space-y-2 text-white/70">
					<p><span class="text-white/50">Name:</span> Juergen Straub</p>
					<p>
						<span class="text-white/50">Address:</span> Ernst-Bumm-Weg 5, 140059 Berlin, Germany
					</p>
					<p><span class="text-white/50">Phone:</span> +49 (0) 151 72187675</p>
					<p>
						<span class="text-white/50">Email:</span>
						<a
							href="mailto:jj@jjstraub.com"
							class="text-primary-400 hover:text-primary-300 transition-colors">jj@jjstraub.com</a
						>
					</p>
				</div>
			</section>
			...
			<section class="bg-surface-800/50 rounded-2xl p-6 md:p-8 border border-white/5">
				...
				<div class="space-y-2 text-white/70">
					<p><span class="text-white/50">Name:</span> Sean Tyler Straub</p>
					<p>
						<span class="text-white/50">Address:</span> Edith-Stein-Straße 66, 68766 Hockenheim, Germany
					</p>
				</div>
			</section>
			...
			<section class="bg-surface-800/50 rounded-2xl p-6 md:p-8 border border-white/5">
				...
				<p class="text-white/70 leading-relaxed">
					...
					information is therefore strictly at your own risk. We do not take responsibility for the
					content of external websites that may be linked to from this website.
				</p>
			</section>
			...
			<section class="bg-surface-800/50 rounded-2xl p-6 md:p-8 border border-white/5">
				...
				<p class="text-white/70 leading-relaxed">
					...
					laws. The use of images featuring Juergen Straub is done with the permission of the
					photographers. The structure, design, and compilation of the website are the exclusive
					property of Sean Tyler Straub and are also protected by international copyright laws.
				</p>
			</section>
			...
			<section class="bg-surface-800/50 rounded-2xl p-6 md:p-8 border border-white/5">
				...
				<div class="space-y-4 text-white/70 leading-relaxed">
					<p>
						...
						improve our services. We do not track, store, or share any personal information.
					</p>
					<p>

// Portfolio data for JJ Straub.
// `category` powers the gallery filters: film | commercial | game | portrait.
// All `src` / `alt` / `caption` / `video` values are preserved from the original site.
...
export const portfolio = [
	...
	},
	{
		...
		caption: 'Reparation Day — Colombian General',
		category: 'film'
	},
	{
	...
	},
	{
		...
		alt: 'JJ Straub: Kingdom Come Deliverance 2',
...
// Filter categories. `labelKey` resolves through svelte-i18n in the UI.
export const categories = [
	{ id: 'all', labelKey: 'filterAll' },
	{ id: 'film', labelKey: 'filterFilm' },
	{ id: 'commercial', labelKey: 'filterCommercial' },
	{ id: 'game', labelKey: 'filterGame' },
	{ id: 'portrait', labelKey: 'filterPortrait' }
];

// Reels (videos), curated for the "Selected Work" section, in feature order.
export const reels = portfolio.filter((item) => item.video);
